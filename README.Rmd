...
# IDEA <a href='https://biogen-inc.github.io/tidyCDISC/'><img src="man/figures/app_ICON.png" align="right" height="139"/></a>
...
As previously mentioned, IDEA can only accept datasets that conform to CDISC ADaM standards with some minor flexibility (see [upload requirements](https://biogen-inc.github.io/tidyCDISC/articles/x00_Data_Upload.html) for more details. At this time, the app only accepts sas7bdat files.
