...
Options to further customize RTF output are currently limited, but the development team will be add plans to add new functionality in the future.

<br> 

### User-defined footnotes

You may have noticed above, but a "Table footnote" field now allows users to supply a custom footnote onto the bottom of the table output.

<br> 

```{r, echo=FALSE, out.width="80%", fig.align = 'center'}
knitr::include_graphics("figures/blog-0-2-1/table_footnote_field.png")
```

<br>

```{r, echo=FALSE, out.width="80%", fig.align = 'center'}
knitr::include_graphics("figures/blog-0-2-1/table_footnote_output.png")
```
...
A footnote with the Source and Run Date is automatically added to all table output

<br> 

```{r, echo=FALSE, out.width="90%", fig.align = 'center'}
knitr::include_graphics("figures/blog-0-2-1/source_footnote.png")
```
