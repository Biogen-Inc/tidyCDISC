...
After datasets are loaded into the application, the Study ID (or IDs, if there are multiple studies) will be displayed on each tab. This lets you easily see which studies you have loaded.

<br>

```{r, echo=FALSE, out.width="90%", fig.align = 'center'}
knitr::include_graphics("figures/blog-0-2-1/studyid.png")
```
...
knitr::include_graphics("figures/blog-0-2-1/download_table.png")
```
