---
title: "Add Individual Explorer Events"
...
This tutorial will walk you through how to add additional  writing an R function to use the block within the `gt` table. 
