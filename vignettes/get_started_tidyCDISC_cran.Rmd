...
knitr::opts_chunk$set(
  collapse = TRUE,
  fig.path = "vignettes/cran_figures/",
  comment = "#>"
)
```
...
knitr::include_graphics("cran_figures/tableGen/TG_need_help.PNG")
```
...
knitr::include_graphics("cran_figures/upldDat/landing_page_tidyCDISC.PNG")
```
...
- [Table Generator](https://Biogen-Inc.github.io/tidyCDISC/articles/x01_Table_Generator.html)

- [Population Explorer](https://Biogen-Inc.github.io/tidyCDISC/articles/x02_Pop_Exp.html)

- [Individual Explorer](https://Biogen-Inc.github.io/tidyCDISC/articles/x03_Indv_Expl.html)
...
```{r, echo=FALSE}
knitr::include_graphics("cran_figures/tableGen/quick_upload_then_tg_tidyCDISC_red.PNG")
```

<br>

There is more to be said about importing data, like, "What constitutes ADaM-ish data?" or "What if my data set won't upload?" To learn more on the topic, head over to the article titled [Data Upload](https://Biogen-Inc.github.io/tidyCDISC/articles/x00_Data_Upload.html); you'll be glad you did! 
...
```{r, echo=FALSE}
knitr::include_graphics("cran_figures/tableGen/02-TG-tidyCDISC.PNG")
```
...
knitr::include_graphics("cran_figures/tableGen/bins.PNG")
```
...
```{r, echo=FALSE}
knitr::include_graphics("cran_figures/tableGen/03-age_mean.PNG")
```
...
```{r, echo=FALSE}
knitr::include_graphics("cran_figures/tableGen/04-diabp_mean.PNG")
```
...
knitr::include_graphics("cran_figures/tableGen/TG_STAN_dropdown.PNG")
```
...
```{r,  echo=FALSE}
knitr::include_graphics("cran_figures/tableGen/t_disp_red.PNG")
```
...
```{r,  echo=FALSE}
knitr::include_graphics("cran_figures/popExp/line_plot_mean_over_time_tidyCDISC.PNG")
```
...
```{r,  echo=FALSE}
knitr::include_graphics("cran_figures/popExp/line_plot_mean_over_time_breakdown.PNG")
```
...
knitr::include_graphics("cran_figures/IndvExp/filter_patients.PNG")
```
...
```{r,  echo=FALSE}
knitr::include_graphics("cran_figures/IndvExp/drill_down_events.PNG")
```
...
```{r,  echo=FALSE}
knitr::include_graphics("cran_figures/IndvExp/drill_down_visits.PNG")
```

<br>

```{r,  echo=FALSE}
knitr::include_graphics("cran_figures/IndvExp/download_report.PNG")
```
