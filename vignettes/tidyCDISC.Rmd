...
Greetings! The [tidyCDISC](https://nate884.shinyapps.io/tidyCDISC/) app is a robust tool which empowers its users to glean informative knowledge from clinical trial data with little resistance. To prove this, we'll take you on a brisk tour of the app, traversing all of it's wonderful features from each tab of the application. 
