...
This tutorial will walk through how to leverage the IDEA app's Individual Explorer tab to establish powerful patient narratives and explore outlier data from specific patients. The Individual Explorer tab will interface with ADSL, BDS, and OCCDs class data files. This tutorial will use 4 files: An ADSL, two BDS' (ADVS & ADLBC), and 1 OCCD (an ADAE). 
