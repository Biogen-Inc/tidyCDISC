...
Below are the currently supported chart types, which can be expanded to include any additional charts. If you have an idea for a useful chart typically used for trial analysis, just send the [developers](mailto:example@email.com?subject=IDEA App Pop Ex Request) an email with your request!
