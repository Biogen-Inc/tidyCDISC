#' popExpBoxp Server Function
#' 
#' Generate a Scatter plot.
#' Child of parent module mod_popExp.R.
#' Calls: fnboxplot, fnsummtab.
#'
#' @param input,output,session Internal parameters for {shiny}. 
#' @param df dataframe passed to mod_popExpBoxp.
...
#' @noRd
#' 
mod_popExpBoxp_server <- function(input, output, session, df){
  ns <- session$ns
...
# mod_popExpBoxp_ui("popExpBoxp_ui_1")
    
## To be copied in the server
# callModule(mod_popExpBoxp_server, "popExpBoxp_ui_1")
