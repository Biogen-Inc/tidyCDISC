...
#' popExpHist Server Function
#'
#' @noRd 
mod_popExpHist_server <- function(input, output, session, df){
  ns <- session$ns
...
# mod_popExpHist_ui("popExpHist_ui_1")
    
## To be copied in the server -- done
# callModule(mod_popExpHist_server, "popExpHist_ui_1")
